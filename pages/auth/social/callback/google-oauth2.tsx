      ...
      <div className={styles.nickname_wrap}>
        ...
        <div className={styles.content_wrap}>
          ...
          <div className={styles.content_inputSection}>
            ...
            <div
              className={styles.content_checkDupbtn}
          ...
          {isCheckBtnClicked && checkResult === "사용 가능한 닉네임입니다." ? (
            ...
            <div className={styles.check_resultFalse}>{checkResult}</div>
          )}
          <div className="callback-notice-wrap">
            <div className="callback-notice check-all">
              <input
                id="check-all"
                type="checkbox"
          ...
          <div className={styles.content_startbtn} onClick={submit}>
            시작하기
          </div>
        </div>
      </div>
